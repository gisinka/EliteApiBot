...
public static class Constants
{
    ...
    public const string JsonLinkWithTagsResolve =
        "https://sapi.demb.uk/api/squads/now/by-tag/extended/{0}?resolve_tags=true&pretty_keys=true";
    public const string JsonLinkWithoutTagsResolve =
        "https://sapi.demb.uk/api/squads/now/by-tag/extended/{0}?pretty_keys=true";
